...
3. The BTT smart filament sensor should be wired as per the following image:
...
4. Locate the IP address of your printer.
...
5. Enter the IP address of your printer into google chrome and hit enter. You'll be greeted by the Fluidd Interface.
